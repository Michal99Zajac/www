        ...
        <section id="experience" className="overflow-hidden">
          <div className="container mx-auto">
            ...
            <div className="companies flex gap-6 px-5">
              <div className="relative w-full grow after:absolute after:left-[9px] after:top-5 after:z-[-1] after:h-[calc(100%-1.25rem)] after:w-[2px] after:border-l-2 after:border-dashed after:border-black after:content-[''] md:after:left-[calc(108px+1rem+9px)]">
